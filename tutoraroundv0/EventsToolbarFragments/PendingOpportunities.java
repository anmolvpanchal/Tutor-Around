 ...
 */
public class PendingOpportunities extends Fragment {
    ...
    ArrayList<Pending_opportunities_API> pending_opportunities_list = new ArrayList<>();


    public PendingOpportunities() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_pending_opportunities, container, false);
        recyclerView = view.findViewById(R.id.pending_opportunities_recyclerview);
        swipeRefreshLayout = view.findViewById(R.id.pending_opportunities_refresh);

        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            @Override
            public void onRefresh() {
                pendingopportunotoes();
    ...
    public void pendingopportunotoes() {
        ...
        Call<ResponseBody> call = apiClient.getPendingOpportunities(user_ID);
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                ...
                try {
                    ...
                    if (root_status.equals("1")) {
                        ...
                        pending_opportunities_list.clear();
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            pending_opportunities_list.add(new Pending_opportunities_API(id, date, time, description, course_name,offer_price));

                            Log.e(TAG, " pending details made posts ne" + id + date + time);


                        }

                        recyclerView.setLayoutManager(new LinearLayoutManager(getActivity(), LinearLayoutManager.VERTICAL, false));
                        AdapterPendingOpportunities adapterPendingOpportunities = new AdapterPendingOpportunities(getActivity(), pending_opportunities_list);
                        recyclerView.setAdapter(adapterPendingOpportunities);
